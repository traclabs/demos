...
std::string Socket::receive()
{
  ...
  std::string::size_type last_newline_idx = string_buffer.rfind(trick_delimiter_, string_buffer.size() - 1);
  std::string::size_type second_last_newline_idx = string_buffer.rfind(trick_delimiter_, string_buffer.size() - 2);
