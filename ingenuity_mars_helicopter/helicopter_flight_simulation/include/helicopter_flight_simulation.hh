...
namespace gz
{
    namespace sim
    {
        ...
        {    
            ...
            {
                // Forward declaration
                class HelicopterFlightSimulationPrivate;

                /// \brief The  HelicopterFlightSimulation system computes lift and drag forces enabling
                ...
                class HelicopterFlightSimulation
                    : public System,
                      ...
                      public ISystemPreUpdate
                {
                    /// \brief Constructor
                public:
                    HelicopterFlightSimulation();

                    /// \brief Destructor
                public:
                    ~HelicopterFlightSimulation() override = default;
                ...
                private:
                    std::unique_ptr<HelicopterFlightSimulationPrivate> dataPtr;
                };
            }
        }
    }
